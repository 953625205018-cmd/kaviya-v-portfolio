...
export const VideoResumePage: React.FC = () => {
  const learnedPoints = [
    'Improved self-introduction',
    'Learned professional presentation',
    'Improved confidence',
    'Learned to present my skills clearly',
  ];

  return (
    <div className="max-w-3xl mx-auto space-y-8 py-4" id="video-resume-page">
      ...
      <div className="rounded-xl bg-[#102A43] p-5 sm:p-6 text-white shadow-xs space-y-2">
        ...
        <p className="text-sm sm:text-base text-slate-200 leading-relaxed">
          Creating a video resume helped me introduce myself confidently and present my skills in a professional way.
        </p>
      </div>
      ...
      <section className="space-y-3">
        ...
        <MediaUploader
          storageKey="video_resume_media"
          acceptedTypes="video"
          sectionName="Video Resume"
          uploadTitle="Upload My Video Resume"
          defaultTitle="Kaviya V - Information Technology Video Resume"
          defaultDescription="Self-introduction and technical competencies showcase."
          badgeLabel="Video Resume"
          studioTheme="video-resume-studio"
      ...
      {/* One short quote */}
      <QuoteBanner
        quote="Present yourself with confidence."
      />
    </div>
  );
};
